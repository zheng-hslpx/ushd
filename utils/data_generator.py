...
def generate_task_instance(num_tasks, num_usvs, area_size_x=(0, 100), area_size_y=(0, 100),
...
def generate_batch_instances(num_instances, fixed_tasks=30, fixed_usvs=3, area_size_x=(0, 100), area_size_y=(0, 100),
                             processing_time_range=(5, 15), battery_capacity=100, speed_range=(5, 10), charge_time=5):
    """生成批量算例，任务和USV数量固定"""
    instances = []
